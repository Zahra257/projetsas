...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Edit Account</h4>
                        ...
                        <div class="card-body">
                            <form action="{{ route('accounts.update', $account->id) }}" method="POST"
                                        ...
                                        <select class="form-select @error('organisationId') is-invalid @enderror"
                                            ...
                                            @foreach ($organisations as $organisation)
                                                <option value="{{ $organisation->id }}"
                                                    {{ old('organisationId', $account->organisation->id) == $organisation->id ? 'selected' : '' }}>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email"
                                            ...
                                            id="secondary_email" name="secondary_email"
                                            value="{{ old('secondary_email', $account->secondary_email) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            ...
                                            value="{{ old('secondary_phone', $account->secondary_phone) }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control @error('address') is-invalid @enderror" id="address" name="address">{{ old('address', $account->address) }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('city') is-invalid @enderror"
                                            id="city" name="city" value="{{ old('city', $account->city) }}" />
                                        @error('city')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select @error('segment') is-invalid @enderror" id="segment"
                                            name="segment">
                                            <option value="">Select Segment</option>
                                            <option value="Bronze"
                                                {{ old('segment', $account->segment) == 'Bronze' ? 'selected' : '' }}>
                                                Bronze</option>
                                            <option value="Silver"
                                                {{ old('segment', $account->segment) == 'Silver' ? 'selected' : '' }}>
                                                Silver</option>
                                            <option value="Gold"
                                                {{ old('segment', $account->segment) == 'Gold' ? 'selected' : '' }}>Gold
                                            </option>
                                            <option value="VIP"
                                                {{ old('segment', $account->segment) == 'VIP' ? 'selected' : '' }}>VIP
                                            </option>
                                        </select>
                                        @error('segment')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control @error('tax_id_1') is-invalid @enderror" id="tax_id_1"
                                            name="tax_id_1" value="{{ old('tax_id_1', $account->tax_id_1) }}" />
                                        @error('tax_id_1')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control @error('tax_id_2') is-invalid @enderror" id="tax_id_2"
                                            name="tax_id_2" value="{{ old('tax_id_2', $account->tax_id_2) }}" />
                                        @error('tax_id_2')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control @error('tax_id_3') is-invalid @enderror" id="tax_id_3"
                                            name="tax_id_3" value="{{ old('tax_id_3', $account->tax_id_3) }}" />
                                        @error('tax_id_3')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control @error('tax_id_4') is-invalid @enderror" id="tax_id_4"
                                            name="tax_id_4" value="{{ old('tax_id_4', $account->tax_id_4) }}" />
                                        @error('tax_id_4')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control @error('tax_id_5') is-invalid @enderror" id="tax_id_5"
                                            name="tax_id_5" value="{{ old('tax_id_5', $account->tax_id_5) }}" />
                                        @error('tax_id_5')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            class="form-control @error('tax_id_6') is-invalid @enderror" id="tax_id_6"
                                            name="tax_id_6" value="{{ old('tax_id_6', $account->tax_id_6) }}" />
                                        @error('tax_id_6')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="active"
                                                name="active" {{ old('active', $account->active) ? 'checked' : '' }}>
